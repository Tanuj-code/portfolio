...
if(ch=="Home"):
    ...
    st.markdown("<a href='https://github.com/tansrh/Booker.com'>Link to github repository</a><br><a href='https://tansrh.github.io/Themer-React-Editor/'>Use the online hosted editor now</a><br>", unsafe_allow_html=True)
    with st.expander("View Details"):
